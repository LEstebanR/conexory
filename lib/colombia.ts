...
export const DEPARTAMENTOS: Departamento[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      "Ebéjico", "El Bagre", "El Carmen de Viboral", "El Retiro", "El Santuario",
      ...
      "Necoclí", "Olaya", "Peñol", "Peque", "Pueblorrico", "Puerto Berrío",
      "Puerto Nare", "Puerto Triunfo", "Remedios", "Rionegro", "Sabaneta",
  ...
  },
  {
    ...
    cities: [
      ...
      "Chiquiza", "Chiscas", "Chita", "Chitaraque", "Chivatá", "Chivor",
      "Ciénega", "Cómbita", "Coper", "Corrales", "Covarachía", "Cubará",
      "Cucaita", "Cuítiva", "Duitama", "El Cocuy", "El Espino",
      ...
      "Páez", "Paipa", "Pajarito", "Panqueba", "Pauna", "Paya", "Paz de Río",
      ...
      "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota", "Turmequé",
  ...
  },
  {
    ...
    cities: [
      ...
      "Nóvita", "Nuquí", "Río Iro", "Río Quito", "Riosucio", "San José del Palmar",
  ...
  },
  {
    name: "Córdoba",
    cities: [
      "Montería", "Ayapel", "Buenavista", "Canalete", "Cereté",
      "Chimá", "Chinú", "Ciénaga de Oro", "Cotorra", "La Apartada",
      "Lorica", "Los Córdobas", "Momil", "Montelíbano", "Moñitos",
  ...
  },
  {
    ...
    cities: [
      ...
      "Cota", "Cucunubá", "El Colegio", "El Peñón", "El Rosal",
      "Facatativá", "Fomeque", "Fosca", "Funza", "Fúquene", "Fusagasugá",
      "Gachalá", "Gachancipá", "Gachetá", "Gama", "Girardot", "Granada",
      "Guachetá", "Guaduas", "Guasca", "Guataquí", "Guatavita", "Guayabal de Síquima",
      ...
      "Útica", "Vergara", "Vianí", "Villa de San Diego de Ubaté",
  ...
  },
  {
    ...
    cities: [
      ...
      "Maicao", "Manaure", "San Juan del Cesar", "Uribia", "Urumita",
      "Villanueva",
    ],
  },
  {
    ...
    cities: [
      ...
      "Chivolo", "Ciénaga", "Concordia", "El Banco", "El Piñón",
      "El Retén", "Fundación", "Guamal", "Nueva Granada", "Pedraza",
      "Pijiño del Carmen", "Pivijay", "Plato", "Pueblo Viejo", "Remolino",
      "Sabanas de San Ángel", "Salamina", "San Sebastián de Buenavista",
  ...
  },
  {
    ...
    cities: [
      ...
      "La Macarena", "La Uribe", "Lejanías", "Mapiripán", "Mesetas",
      "Paradero", "Puerto Concordia", "Puerto Gaitán", "Puerto Lleras",
  ...
  },
  {
    ...
    cities: [
      ...
      "Gramalote", "Hacarí", "Herrán", "Labateca", "La Esperanza",
      "La Playa", "Los Patios", "Lourdes", "Mutiscua", "Ocaña",
  ...
  },
  {
    name: "Santander",
    cities: [
      "Bucaramanga", "Aguada", "Albania", "Aratoca", "Barbosa",
      ...
      "Lebrija", "Los Santos", "Macaravita", "Málaga", "Matanza",
      "Mogotes", "Molagavita", "Ocamonte", "Oiba", "Onzaga",
  ...
  },
  {
    ...
    cities: [
      ...
      "Corozal", "Coveñas", "El Roble", "Galeras", "Guaranda",
      "La Unión", "Los Palmitos", "Majagual", "Morroa", "Ovejas",
      "Palmito", "Sampués", "San Benito Abad", "San Juan de Betulia",
      "San Luis de Sincé", "San Marcos", "San Onofre", "San Pedro",
      "Santiago de Tolú", "Sucre", "Tolú Viejo",
    ],
  },
  {
    name: "Tolima",
    cities: [
      ...
      "Icononzo", "Lérida", "Líbano", "Mariquita", "Melgar",
