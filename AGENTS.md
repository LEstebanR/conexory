...
| `GOOGLE_AI_API_KEY` | Google AI Studio (Gemini Flash) para el copy del flyer de fallback |
| `AI_GATEWAY_API_KEY` | Vercel AI Gateway (Nano Banana) para generar la imagen del flyer con IA; si falta o falla, se usa el render determinístico |
