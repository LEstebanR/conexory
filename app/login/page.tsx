      ...
      <div className="p-3 space-y-2.5">
        ...
        <div className="flex gap-3">
          {["🛏 2 hab", "🚿 1 baño", "📐 65m²"].map((d) => (
            <span key={d} className="text-[9px] text-white/50 font-medium">
              {d}
            </span>
          ))}
        </div>
    ...
    <div className="hidden lg:flex lg:w-[420px] xl:w-[460px] flex-col flex-shrink-0 relative bg-slate-950 p-10 xl:p-12 overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col justify-center gap-8 py-12">
        ...
        <p className="text-sm text-slate-500 leading-relaxed">
          Retoma donde lo dejaste. Tus propiedades, leads y links siguen
        ...
        <div className="flex items-center gap-3">
          <div className="flex -space-x-2">
            {[
              ...
              <div
                key={a.l}
                className={`w-7 h-7 rounded-full ${a.bg} border-2 border-slate-950 flex items-center justify-center text-white text-[10px] font-bold`}
              >
                {a.l}
              </div>
            ))}
          ...
          <p className="text-sm text-slate-400">
            <span className="text-white font-bold">+480 agentes</span> ya usan
            MiAgente
          </p>
        </div>
      </div>
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 lg:px-16 xl:px-20 py-12 max-w-lg lg:max-w-none mx-auto w-full">
          ...
          <Link
            href="/"
            className="hidden lg:inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-slate-700 transition-colors mb-12 w-fit"
          >
          ...
          <div className="max-w-sm xl:max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-sm">
                Ingresa a tu cuenta de MiAgente
              </p>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-slate-200 bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-xs mb-6"
            >
              <GoogleIcon />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full h-12 font-bold shadow-sm shadow-brand-400/20 mt-2"
              >
                Iniciar sesión
