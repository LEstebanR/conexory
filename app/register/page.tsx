...
function MiniSteps() {
  const steps = [
    { icon: Camera, label: "Sube fotos y escribe el precio", num: "01" },
    { icon: LinkIcon, label: "Obtén tu link único", num: "02" },
    { icon: Send, label: "Comparte por WhatsApp", num: "03" },
  ]
    ...
    <div className="space-y-3">
      {steps.map((step, i) => (
        <div key={step.num} className="flex items-center gap-4">
          ...
          <span className="text-xs font-black text-brand-400/40 tabular-nums">
            {step.num}
          </span>
        </div>
      ))}
